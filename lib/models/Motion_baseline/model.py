...
class Model(nn.Module) :
    def __init__(self, 
        ...
        self.encoder = Transformer(depth=2, embed_dim=embed_dim, mlp_ratio=mlp_ratio*embed_dim,
        ...
        self.decoder = Transformer(depth=1, embed_dim=embed_dim//2, mlp_ratio=mlp_ratio*embed_dim,
            num_heads=num_heads, drop_rate=drop_rate, drop_path_rate=drop_path_rate, 
            attn_drop_rate=attn_drop_rate, length=num_frames)
        
        self.proj_local = nn.Linear(embed_dim, embed_dim//2)
        self.local_encoder = Transformer(depth=3, embed_dim=embed_dim, mlp_ratio=mlp_ratio*embed_dim,
            num_heads=num_heads, drop_rate=drop_rate, drop_path_rate=drop_path_rate, 
