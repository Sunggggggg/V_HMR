...
class Trainer():
    ...
    def train(self):
        ...
        for i in range(self.num_iters_per_epoch):
            ...
            smpl_output, mask_ids, smpl_output_global, vitpose_2d_short = self.generator(input_text, input_feat, input_pose, is_train=True)
    ...
    def validate(self):
        ...
        with torch.no_grad():
            for i, target in enumerate(self.valid_loader):
                ...
                smpl_output, mask_ids, smpl_output_global, vitpose_2d_short = self.generator(input_text, input_feat, input_pose, is_train=False, J_regressor=J_regressor)
